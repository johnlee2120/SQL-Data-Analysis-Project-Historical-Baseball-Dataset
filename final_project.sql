...
-- Section 1: School level production analysis

-- View schools and school details tables
SELECT 	* 
FROM 	schools;
SELECT 	*
FROM 	school_details;
...
-- Count the distinct schools producing MLB players per decade
...
-- All time top 5 schools by player production
...
-- Top 3 schools per decade by player production
...
-- Section 2: Team Salary and Spending Analysis
...
-- First year each team surprassed $1 billion in cumulative spending
...
-- Section 3: Player Career Analysis

-- View the players table and find the number of distinct players in the table
...
-- Career duration and age at debut/final game
-- Sorted from longest career to shortest career
...
-- Starting and ending team identification per player
...
-- Amount of players that started and ended on the same team and also played for over a decade
...
-- Section 4: Player Demographics and Comparative Analysis
...
-- Calculate percenteage of right, left, and switch hitters per team
...
-- 4. How the average height and weight at debut game changed over the years. Also the decade over decade difference
